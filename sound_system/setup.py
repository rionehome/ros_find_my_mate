...
setup(
    ...
    data_files=[
        ...
        ('lib/' + package_name+'/module',
         ['module/module_pico.py',
          'module/module_back.py',
          'module/module_make_map.py',
          'module/module_beep.py',
          'module/module_feature.py',
          'module/module_share.py',
          'module/module_position.py',
        ...
        ('lib/sound_system/dictionary/',
         ['dictionary/yes_no.dict',
          ...
          'dictionary/info_age.dict',
          'dictionary/info_age.gram',
          'dictionary/info_color.dict',
          'dictionary/info_color.gram',
    ...
    description='sound package for find my mate',
